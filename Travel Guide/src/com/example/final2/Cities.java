...
public class Cities extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		this.setTitle("Attractions in "+message);
		String State = ReadFromfile("Places.txt", getApplicationContext(),message);
		...
		lv.setOnItemClickListener(new OnItemClickListener() {
			   ...
			   public void onItemClick(AdapterView<?> adapter, View view, int position, long arg) {
				Intent appInfo = new Intent(Cities.this, City.class);
	...
	public String ReadFromfile(String fileName, Context context,String state) {
