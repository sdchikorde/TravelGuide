...
public class City extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		map.put("description", "Information of the city");
		...
		map = new HashMap<String, String>();
		map.put("titre", "Image Gallery");
		map.put("description", "See the place");
		map.put("img", String.valueOf(R.drawable.gallery));
		listItem.add(map);

		map = new HashMap<String, String>();
		map.put("titre", "Map and direction");
		map.put("description", "Get the route to destiny");
		map.put("img", String.valueOf(R.drawable.direction));
		listItem.add(map);
		...
		maListViewPerso.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> a, View v, int position,
				 ...
				 */
				if (position == 0) {
					Intent i = new Intent(City.this, Info.class);
					i.putExtra("message", city);
					startActivity(i);
				} else if (position == 1) {
					Intent i = new Intent(City.this, Image.class);
					i.putExtra("message", city);
					startActivity(i);
				} else if (position == 2) {
					Intent i = new Intent(City.this, MapDir.class);
					i.putExtra("message", city);
					startActivity(i);
				}
			}
